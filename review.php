...
add_action('quick_edit_custom_box', 'aml_product_quick_box', 10, 2);
...
wp_enqueue_script('aml-rating-script', plugins_url('/js/jquery.rating.js', dirname(__FILE__) ));
wp_enqueue_style('aml-rating-style', plugins_url('/css/jquery.rating.css', dirname(__FILE__) ));
